...
export default function Role() {
  ...
  return (
    ...
    <Container>
        ...
        <Col md={4}>
          <Card className="welcome-card">
            ...
            <div className="welcome-icons">
              ...
              <Button variant="primary" onClick={() => handleSelectUserType('Doctor')}>
                I am a Doctor
              </Button>
              </Link>
        ...
        <Col md={4}>
          <Card className="welcome-card">
            ...
            <div className="welcome-icons">
              ...
              <Button variant="primary" onClick={() => handleSelectUserType('pharmacy')}>
                I am a Patients
              </Button>
              </Link>
              <Card.Text>
        ...
        <Col md={4}>
          <Card className="welcome-card">
            ...
            <div className="welcome-icons">
              ...
              <Card.Text>
                View and manage prescriptions and medical data  prescriptions and medical data.
              </Card.Text>
      ...
      {userType && (
        <div className="mt-5">
          <h4>You have selected: <strong>{userType}</strong></h4>
        </div>
      )}
    </Container>
    </section>
