        ...
        <>
            <nav className="d-flex justify-content-end px-5 py-2">
                <div className="nav d-flex mt-3">
                    <div>
                        <NavLink to="/doctorHome" className="link2">Add Patient Prescription</NavLink>
                    </div>
                    <div className="icon">
                                ...
                                medicineList.prescriptions.map((item, index) => (
                                    <div className="accordion-item" key={index}>
                                        ...
                                        <div className="d-flex flex-wrap justify-content-between align-items-center text-start px-3 py-2">
                                            <p className="mb-0"><strong>Date: </strong> {item.created_at}</p>
                                            <p className="mb-0"><strong>Doctor: </strong> {item.doctor}</p>
                                        </div>
                                        <div id={`flush-collapse${index}`} className="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                                            <div className="accordion-body ">
                                                <div className="d-flex flex-wrap justify-content-between align-items-center text-start">
                                                    <p><strong>Medicine Name: </strong> {item.medicine_name}</p>
